 ...
 *
 * Shane Martin
 * Customized by Connie Bainbridge for study - changed p to div for q prompt, centered radio field
 *
...
jsPsych.plugins['survey-multi-choice'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.questions.length; i++) {
      ...
      html += '<div style="text-align: center" id="jspsych-survey-multi-choice-'+question_id+'" class="'+question_classes.join(' ')+'"  data-name="'+question.name+'">';

      // add question text
      html += '<div class="jspsych-survey-multi-choice-text survey-multi-choice">' + question.prompt 
